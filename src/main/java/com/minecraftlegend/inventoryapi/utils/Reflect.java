...
public final class Reflect
{
    ...
    public static Object getValue( Object instance, String fieldName ) throws NoSuchFieldException, IllegalAccessException
    {
        ...
        {
            return getValue( instance, false, fieldName );
        }
    }
    ...
    public static ParameterizedType getGenericSupertype( Class clazz )
    {
        ...
        return type != null ? (ParameterizedType) type : null;
    }

    public static Class<?> getSuperClassTypeArgument( Class clazz, int argument )
    {
        ParameterizedType type = getGenericSupertype( clazz );
        if ( type != null )
            return type.getActualTypeArguments()[argument].getClass();
        else return null;
    }
